...
tmux send-keys -t "${ADAPTER_PANE}" "${SETUP} && ${ROS_ENV} && roslaunch localization_benchmark custom_fastlio_adapter.launch run_id:=0 perturbation_config:=/root/catkin_ws/src/localization_benchmark/config/perturbations/urbannav/per_0.yaml" Enter
