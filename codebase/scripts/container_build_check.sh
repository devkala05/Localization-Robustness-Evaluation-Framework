...
for dataset in urbannav e2o; do
    for per in 0 1 2 3 4 5 6; do
        test -f "/root/catkin_ws/src/localization_benchmark/config/perturbations/${dataset}/per_${per}.yaml"
    done
done
...
python3 /workspace/scripts/algorithm_config.py \
    --config /root/catkin_ws/src/localization_benchmark/config/algorithms.yaml \
    --algo r3live >/dev/null

python3 /workspace/scripts/algorithm_config.py \
    --config /root/catkin_ws/src/localization_benchmark/config/algorithms.yaml \
    --algo lvisam >/dev/null

python3 /workspace/scripts/algorithm_config.py \
    --config /root/catkin_ws/src/localization_benchmark/config/algorithms.yaml \
    --algo fastlivo2 >/dev/null

python3 /workspace/scripts/algorithm_config.py \
    --config /root/catkin_ws/src/localization_benchmark/config/algorithms.yaml \
    --algo rtabmap >/dev/null

python3 /workspace/scripts/algorithm_config.py \
    --config /root/catkin_ws/src/localization_benchmark/config/algorithms.yaml \
    --algo orbslam3 >/dev/null
