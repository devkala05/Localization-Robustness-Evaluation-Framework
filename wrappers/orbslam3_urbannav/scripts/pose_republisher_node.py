...
Important detail:
  ...
  This node therefore applies the inverse of the UrbanNav body-to-camera
  RIGHT_CAMERA_T_IMU extrinsic and normalizes the first body pose to the
  output world frame.
...
# Convention: p_camera = RIGHT_CAMERA_T_IMU * p_body.
