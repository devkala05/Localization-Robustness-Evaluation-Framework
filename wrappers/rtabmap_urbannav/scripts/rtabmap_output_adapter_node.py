...
rtabmap_adapter_node.py feeds FAST-LIO2 odometry to RTAB-Map as an odometry
prior. This node converts RTAB-Map's own mapPath output into the standardized
benchmark odometry/path topics. This prevents the benchmark from accidentally
recording raw FAST-LIO2 odometry for the RTAB-Map algorithm.
"""
import rospy
