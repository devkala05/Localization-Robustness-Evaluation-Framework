...
def main():
    ...
    tfs = [
        make_tf(invert_rigid(CENTER_LIDAR_T_IMU),  'body',     'velodyne'),
        make_tf(invert_rigid(LEFT_LIDAR_T_CENTER),  'velodyne', 'velodyne_left'),
        make_tf(invert_rigid(RIGHT_LIDAR_T_CENTER), 'velodyne', 'velodyne_right'),
        make_tf(invert_rigid(LEFT_CAMERA_T_IMU),    'body',     'camera_left'),
        make_tf(invert_rigid(RIGHT_CAMERA_T_IMU),   'body',     'camera_right'),
