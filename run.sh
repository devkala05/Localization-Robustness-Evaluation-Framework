...
case "${ALGO}" in
    fastlio2|fast_lio2|fast-lio2|rtabmap|rtab_map|rtab-map|adap_w|adap-w|adaptive_w|adaptive-w|adaptive_w_lvio|adaptive-w-lvio|adaptivewlvio)
        ;;
    *)
        echo "ERROR: run.sh --algo supports fastlio2, rtabmap, or adaptive_w_lvio."
