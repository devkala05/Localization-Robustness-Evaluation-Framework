...
if("TRUE" STREQUAL "TRUE")
  set(fast_lio_SOURCE_PREFIX /root/catkin_ws/src/FAST_LIO)
  set(fast_lio_DEVEL_PREFIX /root/catkin_ws/devel/.private/fast_lio)
  set(fast_lio_INSTALL_PREFIX "")
  set(fast_lio_PREFIX ${fast_lio_DEVEL_PREFIX})
else()
  set(fast_lio_SOURCE_PREFIX "")
  set(fast_lio_DEVEL_PREFIX "")
  set(fast_lio_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/devel/.private/fast_lio/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(fast_lio_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/devel/.private/fast_lio/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fast_lio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/FAST_LIO/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/fast_lio/lib;/root/catkin_ws/devel/lib;/opt/ros/noetic/lib)
