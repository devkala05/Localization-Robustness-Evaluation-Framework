...
"""autogenerated by genpy from custom_localization_msgs/CustomImage.msg. Do not edit."""
import codecs
import sys
...
class CustomImage(genpy.Message):
  _md5sum = "22621967f4644ae479b003055d6c7fdd"
  _type = "custom_localization_msgs/CustomImage"
...
"""
  __slots__ = ['header','dataset','sensor_name','source_topic','perturbation_label','image']
  _slot_types = ['std_msgs/Header','string','string','string','string','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,dataset,sensor_name,source_topic,perturbation_label,image
