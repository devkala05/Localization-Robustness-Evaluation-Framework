...
"""autogenerated by genpy from custom_localization_msgs/CustomPointCloud.msg. Do not edit."""
import codecs
import sys
...
class CustomPointCloud(genpy.Message):
  _md5sum = "2026a2fcbfd25a6438c9efeb4c5b631c"
  _type = "custom_localization_msgs/CustomPointCloud"
...
"""
  __slots__ = ['header','dataset','sensor_name','source_topic','perturbation_label','cloud']
  _slot_types = ['std_msgs/Header','string','string','string','string','sensor_msgs/PointCloud2']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,dataset,sensor_name,source_topic,perturbation_label,cloud
    ...
    """
    if args or kwds:
      super(CustomPointCloud, self).__init__(*args, **kwds)
