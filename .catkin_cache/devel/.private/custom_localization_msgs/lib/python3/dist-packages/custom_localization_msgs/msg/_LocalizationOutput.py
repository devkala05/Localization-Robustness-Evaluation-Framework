...
"""autogenerated by genpy from custom_localization_msgs/LocalizationOutput.msg. Do not edit."""
import codecs
import sys
...
class LocalizationOutput(genpy.Message):
  _md5sum = "148a87da3ae1cd47c09a5df07478e78a"
  _type = "custom_localization_msgs/LocalizationOutput"
...
float64 y
float64 z"""
  __slots__ = ['header','algorithm','run_id','source_topic','pose','twist']
  _slot_types = ['std_msgs/Header','string','string','string','geometry_msgs/PoseWithCovariance','geometry_msgs/TwistWithCovariance']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,algorithm,run_id,source_topic,pose,twist
    ...
    """
    if args or kwds:
      super(LocalizationOutput, self).__init__(*args, **kwds)
